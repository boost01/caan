...
For details on how to purchase items seen here, please send us an e-mail: <A HREF="mailto:sales@caancatmobile.org?subject=website purchase">sales@caancatmobile.org</A>, or drop on by: <A HREF="#directions" onClick=window.open("directions.html",null,"statusbar=no,menubar=no,toolbar=no,height=680,width=560")>61 Geneva st. St Catharines</A></p>
</div>
