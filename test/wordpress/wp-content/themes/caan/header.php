...
<h1 id="header"><a href="<?php bloginfo('url'); ?>/"><?php bloginfo('name'); ?></a></h1>
	<div style="position: absolute; width: 800px"><center><img src="http://www.caancatmobile.org/images/logo.jpg"></div>
    <table cellspacing="0" cellpadding="0" id="menu1" class="dm1" width=800px id="header">
    <tr>
        <td>
