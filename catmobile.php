...
<img align=left src=images/catmobile.jpg></td><td>The Cat<B>MOBILE</B> is the first project of CAAN.
<BR>
...
<P>The Cat<B>MOBILE</B> will function as an adoption outreach program by taking homeless cats and kittens into different communities to encourage adoptions.  It also acts as an educational "vehicle" to increase public awareness and encourage public support of <A HREF=index.php?action=nokill>the <B>NO KILL PHILOSOPHY</B></A> in our community.
</div>
<DIV STYLE="margin-left:2px; margin-right:50px; text-align:justify">
<BR><BR>Please join us in thanking those who have already <A HREF="#" onClick=window.open("sponsors.php",null,"statusbar=no,menubar=no,toolbar=no,scrollbars=yes,height=680,width=560")>sponsored and contributed</A> to our cause.
