...
function show_vote_control($poll_id) {
	...
	echo("\t<form class=\"vote\" method=\"post\" action=\"index.php?action=contest&show=vote\">\r\n");
	echo("\t<fieldset>\r\n");
	...
	// Show results link
	echo("\t\t<a href=\"index.php?action=contest&show=results&" . htmlspecialchars($POLL_ID_PARAM_NAME) . "=" . htmlspecialchars($poll_id) . "\">" . htmlspecialchars($VIEW_RESULTS_STRING) . "</a>\r\n");
