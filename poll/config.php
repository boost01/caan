...
$p = new Poll;
$p->question = "Which is your favourite photo?";	// Question displayed to the user
$p->returnToURL = "../index.php?action=contest";				// Specify the URL to return to for this poll; may be relative or absolute
$p->legend = "Contest Poll";					// Form legend; leave empty for none
$p->control_type = $CONTROL_RADIOBUTTONS;		// Control type; $CONTROL_RADIOBUTTONS or $CONTROL_COMBOBOX
$p->add_value("1", "Orange");						// Poll value ID and a display string
$p->add_value("2", "Green");
$p->add_value("3", "Blue");
