...
<tr>
	<td colspan=3><img src="./images/sm_frame_top.gif">
</tr>
<tr>
	<td><img src="./images/sm_frame_left.gif">
	<td align="center" width=196><A HREF="#directions" onClick=window.open("cotm.php?id=<?PHP echo "$id"; ?>",null,"scrollbars=1,statusbar=no,toolbar=no,width=730")><img height=155 src="./images/cats/<?PHP echo $name; ?>.jpg" border=0></A>
	<td><img src="./images/sm_frame_right.gif"><td>
</tr>
<tr>
	<td colspan=3><img src="./images/sm_frame_bottom.gif">
</tr>
</table>
<?PHP
